---
name: bump-version
description: Use when bumping the PlainTab version number across all files — manifest.json, 16 README badge URLs, 16 changelog files, CLAUDE.md, docs/, and all project docs. Triggered by phrases like "更新版本", "bump version", "upgrade to vX.Y.Z", "发布新版本".
---
...
| Project docs | 3 | `CLAUDE.md`, `docs/requirements.md`, `docs/architecture.md` |
| **Total** | **54** | |
