...
<p align="center">
  <img src="https://img.shields.io/badge/version-3.1.0-blue?style=flat-square" alt="버전">
  ...
  <a href="https://plaintab.netlify.app">
    <img src="https://img.shields.io/badge/온라인_체험-Netlify-00c7b7?style=flat-square&logo=netlify" alt="Netlify">
  </a>
</p>
...
PlainTab 프로젝트는 Manifest V3 브라우저 확장 프로그램이자 동시에 독립적인 웹 페이지이다. 제로 외부 의존성, 빌드 단계 불필요, 순수 vanilla JS + CSS. 확장 모드와 웹 모드는 동일한 코드베이스를 공유하며, 런타임에 자동으로 환경을 감지하여 동작을 전환한다. [온라인에서 즉시 사용 가능](https://plaintab.netlify.app).
...
**온라인 시작 페이지**: [plaintab.netlify.app](https://plaintab.netlify.app)에 방문하여 브라우저 설정에서 시작 페이지로 지정.
...
| 배포 방식 | Chrome Web Store / 개발자 로드 | Netlify / GitHub Pages 직접 호스팅 |
...
- **[`docs/`](../docs/)** 와 **[`changelog/`](../changelog/)** — 다국어 문서, 16개 언어 각각 독립 파일
