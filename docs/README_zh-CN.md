...
<p align="center">
  <img src="https://img.shields.io/badge/version-3.1.0-blue?style=flat-square" alt="版本">
...
Bing API 有两个端点主备容灾，语言代码（如 `zh-CN`）映射到 Bing 市场代码，部分语言回退到 `en-US`。
...
- **[`docs/`](../docs/)** 与 **[`changelog/`](../changelog/)** — 多语言文档，16 种语言各自独立文件
