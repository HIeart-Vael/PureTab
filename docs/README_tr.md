...
<p align="center">
  <img src="https://img.shields.io/badge/version-3.1.0-blue?style=flat-square" alt="Sürüm">
...
PlainTab projesi aynı anda hem bir Manifest V3 tarayıcı uzantısı hem de bağımsız bir Web sayfasıdır. Sıfır harici bağımlılık, derleme adımı yok, saf vanilla JS + CSS. Uzantı modu ve Web modu aynı kod tabanını kullanır, çalışma zamanında ortamı otomatik algılar. [Çevrimiçi dene](https://plaintab.netlify.app).
...
**Çevrimiçi başlangıç sayfası**: [plaintab.netlify.app](https://plaintab.netlify.app) adresini ziyaret edin ve tarayıcı ayarlarınızda başlangıç sayfası olarak ayarlayın.
